...
![WhatsApp API](https://tse4.mm.bing.net/th/id/OIP.kxI7UJukLl01GWz6zW4ZpAHaHa?r=0&rs=1&pid=ImgDetMain&o=7&rm=3)
...
```bash
npm install @mrhansamala/X-Baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @mrhansamala/X-Baileys@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@mrhansamala/X-Baileys")
```
# Links
...
```javascript
const makeWASocket = require("@mrhansamala/X-Baileys").default;
const { useMultiFileAuthState } = require("@mrhansamala/X-Baileys");
...
```javascript
const makeWASocket = require("@mrhansamala/X-Baileys").default;
const { useMultiFileAuthState, makeCacheableSignalKeyStore } = require("@mrhansamala/X-Baileys");
...
```javascript
const makeWASocket = require("@mrhansamala/X-Baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@mrhansamala/X-Baileys");
...
```javascript
const makeWASocket = require("@mrhansamala/X-Baileys").default;
const { makeInMemoryStore } = require("@mrhansamala/X-Baileys");
...
const { downloadMediaMessage, getContentType } = require("@mrhansamala/X-Baileys");
